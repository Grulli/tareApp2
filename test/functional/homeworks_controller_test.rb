...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { active: @homework.active, description: @homework.description, expires_at: @homework.expires_at, filename: @homework.filename, name: @homework.name }
    end
  ...
  test "should update homework" do
    put :update, id: @homework, homework: { active: @homework.active, description: @homework.description, expires_at: @homework.expires_at, filename: @homework.filename, name: @homework.name }
    assert_redirected_to homework_path(assigns(:homework))
  end
